...
### 🟠 P2 — Concurrence & ressources — **1 PARTIELLEMENT ouvert sur 5** au 2026-09-08 (était 2 sur 5 au 2026-09-01)

*Reste UNE moitié de constat : `snapshot`/`cancel_job` lisent l'état d'un lot sans `_lock`. CONC-1 a fermé le reste le 2026-09-08 — verrou de crop coupé et master expiré, registre purgé et son énumération verrouillée, annulation devenue préemptive. Le constat des lots ne se ferme donc qu'à moitié, et il est marqué comme tel plutôt que barré : trois choses y étaient réunies, deux sont faites.*
