...
| — | ~~CONC-1 (cache crop TTL + purge jobs + annulation préemptive)~~ ✅ **livré 2026-09-08** · ~~INFRA-4 (retirer `[import-timing]`)~~ ✅ **livré 2026-09-11** · INFRA-5 (reprise `sessionStorage`) · INFRA-6 (sauvegardes auto ShareDocs) | P2-P3 | hygiène / confort |
...
4. ~~Selon le cap suivant : **C1** (déploiement VPS) si le multi-utilisateur devient réel~~
   ...
   2026-09-09). Restent C2, B6 (accord inter-annotateurs) et l'appel de **C6** — **C5** est fait pour
   l'essentiel le 2026-09-11, par EXP-1 puis COL-2
