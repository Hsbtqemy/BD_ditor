...
- [ ] **Les libellés des actes sont validés par Hugo** — attendu : les six libellés de `autorisation.ACTES` (« lire », « annoter », « structurer le corpus », « gérer le vocabulaire », « lancer des lots », « décider qui entre »), celui d'« exporter » et l'avertissement « Supprimer un album efface ses images et ne se rattrape pas. » sont retenus ou remplacés par Hugo, avant que l'écran de l'étape 3 les montre. Posés PROVISOIRES le 2026-09-17 (`3a30843`), repris du tableau de la section « La finesse des droits » ; la coordination les lui soumet
