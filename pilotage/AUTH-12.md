...
- [ ] **La passe « Comptes et groupes » est jouée sur la recette** — attendu : `pilotage/qa/comptes-et-groupes.md` jouée par Hugo sur la pile de recette reconstruite sur `3eb52e8` ou après, avec l'annuaire réellement lu (et non sa doublure), et ses cases cochées par lui. Elle joue les gestes de l'administrateur que la maquette faisait jouer d'abord ; l'annuaire en panne et le regroupement de « À regarder » sont éprouvés par `tests/test_e2e_comptes_groupes.py`, la recette ne permettant ni l'un ni l'autre sans toucher la pile
