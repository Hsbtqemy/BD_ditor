...
et un équivalent, suite par défaut entière verte (1345). **La case reste OUVERTE** : la mesure
en recette attend le compte de service `bd-application`, que Hugo créera. Reportée le
2026-09-17, elle est obligatoire avant la fusion dans `main`. Les deux cases qu'elle bloquait
ont désormais leur signal côté serveur, et attendent l'écran « 👥 Comptes et groupes ».
