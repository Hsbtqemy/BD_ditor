...
en recette a été jouée le même jour, et s'est ARRÊTÉE à la connexion — LLDAP refuse le compte
de service (401), pour une cause hors du code que la coordination a posée à Hugo. Ce qu'elle a
pu établir est écrit dans la case ; elle est à refaire entière, et reste obligatoire avant la
fusion dans `main`. Les deux cases qu'elle bloquait ont leur signal côté serveur ET à l'écran
« 👥 Comptes et groupes » (`3eb52e8`, AUTH-12), et se constateront sur un annuaire lu.
