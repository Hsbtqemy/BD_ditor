...
quelqu'un déjà authentifié. **Non déployé** — aucune session n'a d'accès au serveur, et la
production comme la pile de recette tournent encore sur cinq minutes.
