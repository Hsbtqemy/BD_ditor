...
- [ ] **Où vit l'écran, et la raison est écrite.** La Bibliothèque a été nommée le 2026-09-10, mais la tension se voit déjà : le panneau **👥 Collections** d'Administration (AUTH-3) touche DÉJÀ les collections — il y gère les ACCÈS. Deux écrans qui touchent le même objet doivent se distinguer par une frontière énonçable, sinon on cherchera au mauvais endroit. Candidat de frontière : *qui entre* relève de l'instance (Administration), *ce que la collection EST* relève du corpus (Bibliothèque). L'attendu de cette case est une phrase, pas une préférence
