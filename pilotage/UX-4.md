...
- [ ] **L'Administration est reprise en priorité** : ses panneaux ont été construits pour FONCTIONNER, l'un après l'autre et par des chantiers différents, sans qu'aucun ne réponde de l'ensemble. Attendu : ses panneaux se lisent comme une même page, et non comme des écrans empilés.

  **L'énumération des chantiers est RETIRÉE le 2026-09-18, la raison ne bouge pas.** Elle nommait « INFRA-10, AUTH-3/AUTH-7, SANTE-1, EXP-1 », et la composition de la page a changé les 17 et 18 : les accès d'`AUTH-3` et l'export de dépôt d'`EXP-1` sont partis dans la Bibliothèque (`AUTH-12`, étapes 3), la vue des comptes d'`AUTH-7` a été remplacée par celle d'`AUTH-12`, et le référent de l'instance est arrivé (`AUTH-12`, étape 4). **Son mode d'échec était le pire du dépôt** : elle ne devenait pas absurde, elle gardait du sens en désignant autre chose — et le compte retombait sur QUATRE par coïncidence, ce qui est exactement ce qui empêche de remarquer l'erreur. Les deux « quatre » de la case sont retirés pour la même raison : ils sont vrais aujourd'hui, et le seront jusqu'au prochain panneau. La raison, elle, est plus vraie qu'avant — le dernier panneau arrivé l'a été par un chantier de plus, et toujours sans que personne ne réponde de l'ensemble
