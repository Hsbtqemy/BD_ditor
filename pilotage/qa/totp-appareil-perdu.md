...
- [ ] Le délai qui gouverne ce parcours est CONSTATÉ, puis comparé à ce qu'il faut pour retrouver un téléphone. **Attention à ce que la pile SERT au moment où tu joues, et non à ce que le dépôt déclare** : `elevated_session.code_lifespan` y est posé à **15 minutes** depuis `bcd2e11` (2026-09-14), mais rien n'est déployé — la production comme la pile de recette tournent sur le défaut compilé de la 4.39.22, **5 minutes**, tant que la configuration n'y a pas été recopiée et Authelia redémarré. Constater lequel des deux s'applique fait donc partie de la case, et l'écart est le piège : une passe jouée sur une pile non synchronisée mesurera 5 en croyant mesurer la décision. Pour mémoire, ce qui a été tranché : les 15 minutes de `jwt_lifespan` ne valaient que pour la réinitialisation de mot de passe, alors que le code d'élévation emprunte le MÊME notifier — l'alignement répare cet oubli. Reste entier ce que seule cette passe dira : que le secours passe par l'élévation plutôt que par la réinitialisation
